//! Simplified Escrow Contract for Soroban with Safety Deposit
//! Implements basic atomic swap escrow logic for Stellar (non-EVM)
...
pub struct Escrow {
    ...
    pub token: Option<Address>, // None = XLM
    pub amount: i128,
    pub safety_deposit: i128,
    pub hashlock: BytesN<32>,
    pub expiry: u64,            // final time to reveal or exclusive period end
    pub claimed: bool,
}
